        ...
        <div class="container-fluid p-0">
            <div class="owl-carousel header-carousel position-relative">
                <div class="owl-carousel-item position-relative">
                    <img class="img-fluid" src="img/football_index.jpg" alt="">
                    <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center" style="background: rgba(43, 57, 64, .5);">
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-10 col-lg-8">
                                    <h1 class="display-3 text-white animated slideInDown mb-4">Find Your Teammates or Recruit Others </h1>
                                    <p class="fs-5 fw-medium text-white mb-4 pb-2">
                                        Have fun on the pitch & make new friends

                                    </p>
                                    <a href = "<?php echo $href1 ?>" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Seeking a Player</a>
                                    <a href = "job-list.php" class="btn btn-secondary py-md-3 px-md-5 animated slideInRight">Finding a Team</a>
                                </div>
                            </div>
                        </div>
                    </div>
