...
<body>
    ...
    <!-- Navbar Start -->
        ...
        <div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
            <div class="container">
            <?php
            $select = mysqli_query($conn , "SELECT p.* , u.username , u.phone FROM post p INNER JOIN user u on p.user_id = u.id where p.id = '$postID'");
                    ...
                    <div class="col-lg-8">
                        <div class="d-flex align-items-center mb-5">
                            ...
                            <div class="text-start ps-4">
                                ...
                                <span class="text-truncate me-3"><i class="far fa-clock text-primary me-2"></i><?php echo $row['post_time'];?></span>
                            </div>
                        </div>
...
<?php
    ...
    ?>
                ...
                <div class="row gy-5 gx-4">
                    <div class="col-lg-8">
                        <div class="mb-5">
                            <h4 class="mb-3">Post Tags</h4>
                              <?php
            $select = mysqli_query($conn , "SELECT t.title FROM post_tag INNER JOIN post on post_tag.post_id = post.id INNER JOIN tag t on post_tag.tag_id = t.id where post.id = '$postID'");
            while ($row = mysqli_fetch_assoc($select)) {
            ?>
